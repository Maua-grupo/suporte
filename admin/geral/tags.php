...
<body class="app-embedded-screen">
	...
	<div class="container-fluid">
		<h4 class="my-4"><i class="fas fa-hashtag text-secondary"></i>&nbsp;<?= TRANS('INPUT_TAGS'); ?></h4>
        ...
        $inputTags = getTagsList($conn, $cod);
		...
		?>
			...
			?>
				<table id="table_lists" class="stripe hover order-column row-border" border="0" cellspacing="0" width="100%">
					...
					<tbody>
						<?php
						foreach ($inputTags as $row) {
                            $tag = $row['tag_name'];
							?>
							<tr>
								<td class="line"><?= $row['tag_name']; ?></td>
		...
		if ((isset($_GET['action'])  && ($_GET['action'] == "new")) && !isset($_POST['submit'])) {
			...
			<form method="post" action="<?= $_SERVER['PHP_SELF']; ?>" id="form">
				...
				<div class="form-group row my-4">
					<label for="tag_name" class="col-md-2 col-form-label col-form-label-sm text-md-right"><?= TRANS('COL_NAME'); ?></label>
					<div class="form-group col-md-10">
						<input type="text" class="form-control " id="tag_name" name="tag_name" rows="4" required />
					</div>
		...
		?>
			...
			<form method="post" action="<?= $_SERVER['PHP_SELF']; ?>" id="form">
				...
				<div class="form-group row my-4">
					<label for="tag_name" class="col-md-2 col-form-label col-form-label-sm text-md-right"><?= TRANS('COL_NAME'); ?></label>
					<div class="form-group col-md-10">
						<input type="text" class="form-control " id="tag_name" name="tag_name" rows="4" value="<?= $inputTags['tag_name']; ?>" required />
					</div>
