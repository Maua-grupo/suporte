    ...
    <div class="container">
        ...
        ?>
            ...
            $query = "SELECT count(o.numero) quantidade, u.nome operador, s.sistema area 
                FROM ocorrencias as o, usuarios as u, sistemas as s, `status` st
                WHERE 
            ...
            if ((!isset($_POST['d_ini'])) || (!isset($_POST['d_fim']))) {
                ...
                if ($d_ini <= $d_fim) {
                    ...
                    //     "GROUP BY o.operador ORDER BY quantidade desc, area";

                    $query .= " {$extraTerms} {$clausule}
                        GROUP BY u.nome, s.sistema ORDER BY quantidade desc, area";
