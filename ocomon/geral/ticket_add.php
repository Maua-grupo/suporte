			...
			<form name="form" id="form" method="post" action="<?= $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
				...
				<div class="form-group row my-4">
                    ...
                    if ((isset($screen['conf_scr_unit']) && $screen['conf_scr_unit']) || empty($screen)) {
                        ?>
                        <label for="idUnidade" class="col-sm-2 col-md-2 col-form-label col-form-label-sm text-md-right">Empresa</label>
                        <div class="form-group col-md-10">
                            <select class="form-control bts-select" id="idUnidade" name="instituicao" required>
