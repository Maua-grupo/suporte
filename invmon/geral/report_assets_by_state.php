    ...
    <script type='text/javascript'>
        $(function() {
            ...
            $('#idSubmit').on('click', function() {
                ...
                $.ajax({
					url: './report_assets_by_state_process.php',
					method: 'POST',
					data: $('#form').serialize(),
					dataType: 'json',
				}).done(function(data) {
					...
					if (!data.success) {
                        ...
                        table += '<thead>';
                            table += '<tr class="header table-borderless">';
                                table += '';
                                table += '<td class="line"><?= mb_strtoupper(TRANS('STATE')); ?></td>';
                        ...
                        for (var i in data['table']) {
                            ...
                            if (data['table'][i].asset_type !== undefined) {
                                table += '<tr>';
                                table += '<td class="line">' + data['table'][i].state + '</td>';
                        ...
                        const chart_01 = report_assets_general(data, 'chart_01', 'state', 'graph_01');
