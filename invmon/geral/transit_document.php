...
$terms = getStatementsInfo($conn, 'termo-transito');
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
    ...
    <div class="container-fluid">
        ...
        <!-- <small class="d-print-none bg-warning">&lt;&lt;Configure em Admin::Inventário&gt;&gt;</small> -->
        <?php
            if ($terms['header'] != '') {
                ?>
            ...
            if ($terms['title'] != '') {
                ?>
                <h4 class="my-5"><i class="fas fa-dolly-flatbed text-secondary"></i>&nbsp;<?= $terms['title']; ?></h4>
                <?php
            }
        ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="bill-to">
                            ...
                            <address>
                                <br />
                                <?= TRANS('FIELD_CARRIER'); ?>:&nbsp;<span class="text-dark"><input type="text" class="input-line" /></span>
                                <br />
                                <?= TRANS('FIELD_DESTINY'); ?>:&nbsp;<span class="text-dark"><input type="text" class="input-line" /></span>
                                <br />
                                <?= TRANS('FIELD_REASON'); ?>:&nbsp;<span class="text-dark"><input type="text" class="input-line" /></span>
                                <br />
                                <?= TRANS('AUTHORIZED_BY'); ?>:&nbsp;<span class="text-dark"><input type="text" class="input-line" /></span>
                                <br />
                                <?= TRANS('RESPONSIBLE_DEPARTMENT'); ?>:&nbsp;<span class="text-dark"><input type="text" class="input-line" /></span>
                            </address>
                        </div>
                    </div>
                    <div class="col-md-6">
