...
<body>
    ...
    <div class="container">
        ...
        ?>
            ...
            if (isset($_POST['equipment_type']) and (!empty($_POST['equipment_type']))) {
                ...
                $filter_to_total = " AND comp_tipo_equip IN ({$fieldIn}) ";
            ...
            if (isset($_POST['unit']) and (!empty($_POST['unit']))) {
                ...
                $filter_to_total = " AND comp_inst IN ({$fieldIn}) ";
            ...
            $sqlTotalCount = $QRY["total_equip"] . " WHERE 1 = 1 {$filter_to_total}";
            $resTotalCount = $conn->query($sqlTotalCount);
            $total = $resTotalCount->fetch()['total'];

            $query_base = "SELECT count(*) as quantidade, count(*)*100/" . $total . " as percentual,  
            ...
            $queryChart1 = "SELECT count(*) as quantidade, count(*)*100/" . $total . " as percentual,  
                                C.comp_tipo_equip, T.tipo_nome AS equipamento ";
            $queryChart1 .= $queryRules . $query_filter . 
                        " GROUP BY C.comp_tipo_equip, equipamento ORDER BY quantidade DESC, equipamento";
            ...
            $queryChart5 = "SELECT count(*) as quantidade, count(*)*100/" . $total . " as percentual,  
            ...
            $query_base .= " GROUP BY C.comp_tipo_equip , equipamento, tipo, unit_cod, unit_name 
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <thead>
                            <tr class="header table-borderless">
                                ...
                                <td class="line"><?= mb_strtoupper(TRANS('PERCENTAGE')); ?></td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
    ...
    <script type='text/javascript'>
        ...
        function showChart(canvasID) {
            ...
            var myChart = new Chart(ctx, {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: '<?= TRANS('GENERAL_DISTRIBUTION','',1); ?>',
                    },
                    scales: {
                        yAxes: [{
                            display: false,
        ...
        function showChart5(canvasID) {
            ...
            for (var i in dataFromPHP) {
                // console.log(dataFromPHP[i]);
                labels.push(dataFromPHP[i].unit_name);
                total.push(dataFromPHP[i].quantidade);
            }
