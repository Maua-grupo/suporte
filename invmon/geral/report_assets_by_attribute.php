...
<body class="app-embedded-screen">
    ...
    <div class="container">
        <h5 class="my-4"><i class="fas fa-ruler-combined text-secondary"></i>&nbsp;<?= TRANS('ASSETS_BY_ATTRIBUTE'); ?></h5>
        ...
        ?>
            <form method="post" action="<?= $_SERVER['PHP_SELF']; ?>" id="form">
                <div class="form-group row my-4">
                    ...
                    <label for="asset_attribute" class="col-sm-2 col-md-2 col-form-label col-form-label-sm text-md-right"><?= TRANS('ATTRIBUTE'); ?></label>
                    <div class="form-group col-md-10">
                        <select class="form-control bs-select" id="asset_attribute" name="asset_attribute">
                            <?php
    ...
    <script type='text/javascript'>
        $(function() {
            ...
            $('#idSubmit').on('click', function() {
                ...
                $.ajax({
					url: './report_assets_by_attribute_process.php',
					method: 'POST',
					data: $('#form').serialize(),
					dataType: 'json',
				}).done(function(data) {
