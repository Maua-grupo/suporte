...
<body class="app-embedded-screen">
    ...
    <div class="container">
        <h5 class="my-4"><i class="fas fa-microchip text-secondary"></i>&nbsp;<?= TRANS('TTL_COMP_X_PROCESSOR'); ?></h5>
        ...
        ?>
            ...
            $query_base = "SELECT count(*) as quantidade,  
                    ...
                    CONCAT(mif.fab_nome, ' ', mi.mdit_desc, ' ', mi.mdit_desc_capacidade, ' ', mi.mdit_sufixo) AS processador_full 
                ...
                WHERE 
                    ...
                    C.comp_proc = mi.mdit_cod AND 
                    mi.mdit_manufacturer = mif.fab_cod AND
                    mi.mdit_tipo = 11 {$termsAllowedUnits}
            ";
            ...
            $queryChart1 .= $queryRules . $query_filter . 
                        " GROUP BY processador_full ORDER BY quantidade DESC, processador_full";
            ...
            CONCAT(mi.mdit_desc_capacidade, ' ', mi.mdit_sufixo) AS processador_capacidade ";
            $queryChart2 .= $queryRules . $query_filter . 
                        " GROUP BY processador_capacidade ORDER BY quantidade DESC, processador_capacidade";
            ...
            mif.fab_nome AS processador_fabricante ";

            $queryChart3 .= $queryRules . $query_filter . 
                        " GROUP BY processador_fabricante ORDER BY quantidade DESC, processador_fabricante";
            ...
            $queryChart4 = "SELECT count(*) as quantidade,  
                mi.mdit_desc AS processador_modelo ";

            $queryChart4 .= $queryRules . $query_filter . 
                        " GROUP BY processador_modelo ORDER BY quantidade DESC, processador_modelo";
            ...
            $query_base .= " GROUP BY processador_full, equipamento  
                        ORDER BY equipamento, quantidade DESC, processador_full";
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <thead>
                            <tr class="header table-borderless">
                                ...
                                <td class="line"><?= mb_strtoupper(TRANS('PROCESSOR')); ?></td>
                        ...
                        <tbody>
                            ...
                            foreach ($resultado->fetchall() as $row) {
                                ...
                                <tr class=" table-borderless">
                                    ...
                                    <td class="line"><?= $row['processador_full'];?></td>
    ...
    <script type='text/javascript'>
        ...
        function showChart(canvasID) {
            ...
            for (var i in dataFromPHP) {
                ...
                labels.push(dataFromPHP[i].processador_full);
            ...
            var myChart = new Chart(ctx, {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: '<?= TRANS('DISTRIBUTION_BY_PROCESSOR_TYPE','',1); ?>',
                    },
                    scales: {
                        yAxes: [{
                            display: false,
        ...
        function showChart2(canvasID) {
            ...
            for (var i in dataFromPHP2) {
                ...
                labels.push(dataFromPHP2[i].processador_capacidade);
            ...
            var myChart2 = new Chart(ctx2, {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: '<?= TRANS('DISTRIBUTION_BY_PROCESSOR_SIZE','',1); ?>',
                    },
                    scales: {
                        yAxes: [{
                            display: false,
        ...
        function showChart3(canvasID) {
            ...
            for (var i in dataFromPHP2) {
                // console.log(dataFromPHP2[i]);
                labels.push(dataFromPHP2[i].processador_fabricante);
                total.push(dataFromPHP2[i].quantidade);
            }
        ...
        function showChart4(canvasID) {
            ...
            for (var i in dataFromPHP2) {
                // console.log(dataFromPHP2[i]);
                labels.push(dataFromPHP2[i].processador_modelo);
                total.push(dataFromPHP2[i].quantidade);
            }
